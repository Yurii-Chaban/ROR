names = ['Stuart Blanda', 'Kaden Batz', 'Cornell Durgan',
         'Mrs. Kieran Goldner', 'Miss Emile Littel',
         'Carolyne Terry', 'Mrs. Ronaldo Buckridge',
         'Cristal Braun', 'Dr. Joanne Bartoletti',
         'Kenton Block', 'Jeromy Medhurst', 'Gussie Daniel V',
         'Kitty Senger Jr.', 'Lexus Gibson', 'Kaylah Howell',
         'Maxie Wilderman', 'Kayden Mohr', 'Devonte Skiles',
         'Tina Mante', 'Heloise Mann']

# 1

replaceArray = ['Mrs.', 'Miss', 'Mrs.', 'Dr.', ' V', 'Jr.']
# array with word and space for delete
...
def uniqLetter(letterArray)
  ...
  alphabeticUniq = uniqFirstLetter.sort_by(&:downcase)
